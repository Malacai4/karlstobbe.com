...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./styles/online-concerts.css">

    <!-- Head -->
    <?php include './includes/head.php';?>

    <!-- Title -->
    <title>Online Concerts - Karl Stobbe</title>
  </head>
  <body>
    <!-- Header -->
    ...
    <!-- Page Content -->
    <section class="online-concerts">
      <h1 class="name">ONLINE CONCERTS</h1>

      <p class="wrap-image">
        <img
            src="./styles/images/Karl_on_stage_•_FOTS_•_31-7-19-1.jpeg"
            alt=""
            style="float: left; margin-right: 20px"
            width="50%"
          />
        Even with live concerts starting up again, I still get requests to continue with Karl’s Online Concerts. I am planning on doing another series, but haven’t settled on a date yet.  I have been busy recording things with friends (chamber music this time), and am planning on asking a few other people if they’d like to participate with their own material. If you have requests – now’s a good time to make them (<a href="mailto:karlstobbe@karlstobbe.com">karlstobbe@karlstobbe.com</a>)!! Otherwise, stay tuned, and hopefully we can have an online reunion in the near future!! 
      </p>

      <div class="mid-section">
        <div class="dates">
          <b>
            February dates:<br /><br />Two concerts per day – one at 8:30pm EST,
            and one at 8:00pm PST.<br /><br />
          </b>
          <br />
          <br />
          <i class="panels">
            <div class="left-panel" style="padding-right: 1vw">
              ...
              - Bach Sonata No. 2 in A Minor<br /><br />
            </div>
            <div class="right-panel" style="padding-left: 1vw">
      ...
      <p class="wrap-image">
        <img
          src="./styles/images/photos/full-version/9-JudyBandsmer_PaintbrushPhotography.jpg"
          alt=""
      ...
      <div class="trailers">
        <div class="row">
          <iframe
            src="https://player.vimeo.com/video/498414074"
            frameborder="0"
            allow="autoplay; fullscreen; picture-in-picture"
          ></iframe>
          <iframe
            src="https://player.vimeo.com/video/498414726"
            frameborder="0"
            allowfullscreen=""
          ></iframe>
        </div>
        <div class="row">
          <iframe
            src="https://player.vimeo.com/video/498415613"
            frameborder="0"
            allowfullscreen=""
          ></iframe>
          <iframe
            src="https://player.vimeo.com/video/498416309"
            frameborder="0"
            allowfullscreen=""
          ></iframe>
        </div>
        <div class="row">
          <iframe
            src="https://player.vimeo.com/video/498417210"
            frameborder="0"
            allowfullscreen=""
          ></iframe>
          <iframe
            src="https://player.vimeo.com/video/498418012"
            frameborder="0"
            allowfullscreen=""
          ></iframe>
        </div>
      ...
      <p class="after-note" style="text-align: justify">
        ...
        March.<br /><br />Trying to make the best of things, I decided that I
        ...
        forever.<br /><br />Early in this endeavour I started experimenting with
        ...
        was a very steep learning curve.<br /><br />After finishing a couple of
        ...
        them as time goes on.<br /><br />Towards the end of recording I started
        ...
        before and after, it’s an excellent tool.<br /><br />Putting these
        ...
        forward to meeting you online soon!<br /><br />Karl Stobbe
      </p>
    </section>
