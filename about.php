...
<html lang="en">
  ...
  <body>
    ...
    <!-- Page Content -->
    <section class="about">
      <h1 class="name">KARL STOBBE, VIOLINIST</h1>

      <div class="bio">
        <p style="text-align: justify">
          <img
            src="./styles/images/photos/full-version/5-JudyBandsmer_PaintbrushPhotography.jpg"
            alt=""
          ...
          six Ysaÿe Sonatas for Solo Violin, all 16 Beethoven String Quartets,
          ...
          breathtaking range of tone colours.”<br /><br />Karl has performed in
          ...
          Ysaÿe’s Solo Violin Sonatas received worldwide attention, including
          ...
          has been involved in numerous commissions and world premieres.<br /><br />Always
          ...
          of music by Bartok, Ysaye, Prokofiev, Biber, and others.<br /><br />A
          ...
          exceptional and rare violin by Nicolas Lupot, in Paris, 1806.<br /><br />www.karlstobbe.com
        </p>
      </div>

      <div class="links">
        <a
          href="./styles/PDFs/karl-stobbe-long-bio.pdf"
          target="_blank"
          class="pdf"
          >Karl Stobbe Long Bio PDF</a
        >

        <a
          href="./styles/PDFs/karl-stobbe-medium-bio.pdf"
          target="_blank"
          class="pdf"
          >Karl Stobbe Medium Bio PDF</a
        >

        <a
          href="./styles/PDFs/karl-stobbe-short-bio.pdf"
          target="_blank"
          class="pdf"
          >Karl Stobbe Short Bio PDF</a
        >
      </div>
